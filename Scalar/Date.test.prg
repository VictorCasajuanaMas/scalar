...
METHOD Test_Dow() CLASS Test_Date
    ...
    ::Assert():Equals( 1, 0d20220725:Dow() )
    ::Assert():Equals( 2, 0d20220726:Dow() )
    ::Assert():Equals( 3, 0d20220727:Dow() )
    ::Assert():Equals( 4, 0d20220728:Dow() )
    ::Assert():Equals( 5, 0d20220729:Dow() )
    ::Assert():Equals( 6, 0d20220730:Dow() )
    ::Assert():Equals( 7, 0d20220731:Dow() )
